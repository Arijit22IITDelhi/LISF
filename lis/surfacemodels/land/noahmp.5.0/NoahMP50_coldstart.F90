    ...
    do n=1, LIS_rc%nnest
        ...
        if (trim(LIS_rc%startcode) .eq. "coldstart") then
           ...
           do t=1, LIS_rc%npatch(n,mtype)
             ...
             NoahmpIO%IOPT_BTR         = NoahMP50_struc(n)%btr_opt    ! added by A. Chakraborty (2025)
             ...
             ! --- Assign PEAT physics only if soiltype == 17 and peat_opt == 1, added by A Chakraborty (2025)---
